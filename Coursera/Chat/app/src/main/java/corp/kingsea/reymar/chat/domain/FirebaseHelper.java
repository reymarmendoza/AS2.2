package corp.kingsea.reymar.chat.domain;

/**
 * https://firebase.google.com/support/guides/firebase-android?hl=es  actualizar al nuevo firebase
 **/
...
public class FirebaseHelper {
    ...
    private void notifyContactsOfConnectionChange(final boolean online, final boolean signOff) {//final boolean online,final boolean signOff
